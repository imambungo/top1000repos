...
{#await promise then emoji_image_urls}
	{#if description} <!-- some description is null -->
		<div class="text-sm text-gray-800 line-clamp-4 break-words"> <!-- https://stackoverflow.com/a/41137262/9157799 | https://tailwindcss.com/docs/plugins#line-clamp | https://stackoverflow.com/a/75308868/9157799 -->
