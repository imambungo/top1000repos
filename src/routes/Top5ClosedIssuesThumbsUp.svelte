...
{#if has_issues_tab}
	<div class='whitespace-nowrap'>
		<a on:mousedown href={top_5_closed_issues_url} target='_blank' title='total 👍 of the top 5 closed issues of the last 12 months'> <!--  on:click ==> https://svelte.dev/tutorial/dom-event-forwarding  -->
