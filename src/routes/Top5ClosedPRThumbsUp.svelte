<script>
	export let total_thumbs_up_of_top_5_closed_pr_since_1_year
	export let html_url
...
<div class='whitespace-nowrap'>
	<a on:click href={top_5_closed_pr_url} target='_blank' title='total 👍 of the top 5 closed (possibly merged) PRs of the last 12 months'> <!--  on:click ==> https://svelte.dev/tutorial/dom-event-forwarding  -->
