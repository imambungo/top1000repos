export const sort_repos_based_on_sort_option = (repos, sort_option) => {
   const compare = (a, b) => {
      ...
      if (isNaN(a)) a = null // parseInt(null) is NaN. If PR, issues, size is null because it's new repo that just got into the top 1000, make it stays null because null < 123 is true while NaN < 123 is false
      if (isNaN(b)) b = null
